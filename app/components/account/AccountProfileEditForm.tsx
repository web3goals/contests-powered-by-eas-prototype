 ...
 */
export default function AccountProfileEditForm(props: { profileData: any }) {
  ...
  async function submit(values: any) {
    try {
      ...
      const profileUriData = {
        name: "Contests powered by EAS - Profile",
                ...
                <Box display="flex" flexDirection="column" alignItems="center">
                  <Avatar
                    sx={{
                      ...
                      height: 164,
                      borderRadius: 164,
                      background: emojiAvatarForAddress(address || zeroAddress)
                        .color,
                    }}
                    src={
                      formImageValue?.uri ||
                  ...
                  >
                    <Typography fontSize={64}>
                      {emojiAvatarForAddress(address || zeroAddress).emoji}
                    </Typography>
                  </Avatar>
                </Box>
              </div>
